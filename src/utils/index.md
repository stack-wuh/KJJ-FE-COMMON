...
export default () => {
  ...
  return (<>
    <p>Current is str: <pre style={{ backgroundColor: '#f2f2f2' }} dangerouslySetInnerHTML={{
      __html: str
    }} /></p>
    <hr />
    <p>Current is oilStr: <pre style={{ backgroundColor: '#f2f2f2' }} dangerouslySetInnerHTML={{
      __html: oilStr
    }} /></p>
  </>)
}
